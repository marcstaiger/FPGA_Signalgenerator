...
Eine zentrale Fragestellung dabei: Wie lassen sich aus einem einzigen, festen 50\,MHz-Systemtakt unterschiedlich schnelle Ausgabefrequenzen erzeugen? Der naheliegende, aber ungeeignete Ansatz wäre, selbst einen langsameren Takt zu erzeugen, zum Beispiel indem man ein Bit eines Zählers als Takt für andere Register verwendet.

Das Problem dabei: Der echte 50\,MHz-Takt läuft im FPGA über spezielle, extrem schnelle Verteilleitungen, die dafür sorgen, dass er an jedem Flipflop praktisch zeitgleich ankommt. Ein selbstgebauter Takt läuft dagegen über ganz normale Signalleitungen und kommt an verschiedenen Registern leicht zeitversetzt an. Bei wenigen Registern fällt das nicht unbedingt auf, bei vielen kann es zu Fehlern führen, die in der Simulation unsichtbar bleiben und erst auf der echten Hardware als sporadisches Rauschen oder Aussetzer auftauchen.
...
\section{Der Mystery-Modus}

Modus 6 ist ein kleines Extra, unabhängig von \texttt{P1}, \texttt{P2} und Amplitude. Was genau dieser Modus macht, verrät dieses Kapitel bewusst nicht, das findest du am besten selbst heraus, indem du ihn ausprobierst und dir anschließend den zugehörigen Code ansiehst.
