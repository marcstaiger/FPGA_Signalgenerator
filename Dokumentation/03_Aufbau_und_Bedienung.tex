...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Bilder/Lautsprecher-magnet.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Bilder/Signalgenerator_angesteck.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Bilder/fertig_monitiert_mit_stecker.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=15cm]{Bilder/Platine_1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Bilder/steuerungs_bottonbelegung.png}
