    ...
    begin
        if rising_edge(clk_sys) then
            ...
            if sw6_clean = '0' and sw6_d = '1' then
                -- TODO: der Wurm findet Minus-Taster wohl unnoetig. Analog zu
                -- Taster 5, aber verringern statt erhoehen. Achtung: unsigned kann
                -- nicht negativ werden! p1_reg und p2_reg bei 1 stoppen (nicht 0),
                -- amp_reg bei 0 stoppen.
            end if;
